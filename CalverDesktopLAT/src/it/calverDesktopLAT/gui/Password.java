...
public class Password extends JPanel implements ActionListener {
	...
	protected JComponent createButtonPanel() {
		...
		okButton.setPreferredSize(new Dimension(32, 32));
		okButton.setIcon(new ImageIcon(Password.class.getResource("/image/continue.png")));
		okButton.setFont(new Font("Algerian", Font.BOLD, 11));
		...
		if (OK.equals(cmd)) { //Process the password.
			...
			if (isPasswordCorrect(input)) 
			{
				...
				JOptionPane.showMessageDialog(controllingFrame,
						"Password Errata",
						"Error Message",
						JOptionPane.INFORMATION_MESSAGE,new ImageIcon(PannelloTOP.class.getResource("/image/error.png")));
			}
