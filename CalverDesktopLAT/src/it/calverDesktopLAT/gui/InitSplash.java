...
public class InitSplash extends JFrame{
	...
	public InitSplash() {
		setUndecorated(true);
		setIconImage(Toolkit.getDefaultToolkit().getImage(InitSplash.class.getResource("/image/logo.png")));
		setResizable(false);
		...
		getContentPane().setLayout(new MigLayout("", "[grow]", "[grow]"));
		 ...
		 lblNewLabel.setIcon(new ImageIcon(InitSplash.class.getResource("/image/splash.png")));
