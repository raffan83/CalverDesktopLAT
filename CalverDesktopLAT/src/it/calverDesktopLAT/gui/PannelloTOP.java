...
import it.calverDesktopLAT.gui.PannelloImpostazioni.ValidateThread;
...
button.addActionListener(new ActionListener() {
	...
	public void actionPerformed(ActionEvent e) {
 		...
 		boolean execute=GestioneDB.checkFile(Costanti.PATH_DB);
	    		...
	    		{
	    			JOptionPane.showMessageDialog(null,"File è chiuso - non utilizzabile","File chiuso",JOptionPane.ERROR_MESSAGE,new ImageIcon(PannelloTOP.class.getResource("/image/error.png")));
	    		}
 		}else
 		{
...
//				    		}else
//				    		{
//				    			JOptionPane.showMessageDialog(null,"File gi� chiuso - non utilizzabile","File chiuso",JOptionPane.ERROR_MESSAGE,new ImageIcon(PannelloTOP.class.getResource("/image/error.png")));
//				    		}
//			    		}else
//			    		{
//			    			JOptionPane.showMessageDialog(null,"Nessun file selezionato","Nessun file ... ",JOptionPane.ERROR_MESSAGE,new ImageIcon(PannelloTOP.class.getResource("/image/error.png")));
